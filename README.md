...
> Dica: seja estratégico nas interações, já que o plano gratuito limita a 5 respostas por dia.

### 4. Documentação da Entrega
No README do repositório, incluir:  
- O **prompt final (PRD)**.  
- Prints ou vídeos das interações com a IA.  
